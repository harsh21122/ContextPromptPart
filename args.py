...
def get_parser():
    ...
    parser.add_argument('--model-name', default='../ContextPromptPart_model/last_model_3e-1_sched_only_contrast',  help='if resume from checkpoint is true, name and path of model to load')
    ...
    parser.add_argument('--lamda_cross', default=0.0, type=float, help='cross entropy loss weightage')
