...
class FPN(nn.Module):
    ...
    def __init__(self, num_blocks = [3, 4, 6, 3], num_classes = 32, back_bone='resnet', pretrained=True):
    ...
    def forward(self, x):
        ...
        # Top-down
        p5 = self.toplayer(c5)
        # print(f"P2 shape: {p5.shape}")
        p4 = self._upsample_add(p5, self.latlayer1(c4))
        # print(f"P2 shape: {p4.shape}")
        p3 = self._upsample_add(p4, self.latlayer2(c3))
        # print(f"P2 shape: {p3.shape}")
